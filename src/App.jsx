...
const T = {
  en: {
    ...
    hero: { greeting: "Hello, I'm", name: "Umidbek Karimov", role: "Junior 3D Animator | Motion Designer", bio: "As a Junior 3D Animator and Motion Designer, I specialize in creating fluid, performance-driven 3D animations and dynamic video content. My focus lies in mastering the fundamentals of motion—weight, timing, and storytelling—within Autodesk Maya and After Effects to deliver high-quality visual experiences. Open to full-time and freelance opportunities in game studios, animation productions, and video agencies.", cta1: "View Showreel", cta2: "Contact Me", badge: "Available for hire", scroll: "Scroll" },
    work: { label: "My Portfolio", heading: "Giving Life to\nDigital Characters", showreelTitle: "Production Showreel 2026", showreelMeta: "2 min 30 sec  ·  HD 1080p", projects: [{ title: "Post - Production & Commercial Motion", category: "Motion Capture · Post-Production" }, { title: "Soon..", category: "3D · CGI" }] },
    about: { label: "About Me", heading: "Passionate about\n3D Character Animation", bio1: "I'm a Junior 3D Animator dedicated to mastering character motion. I focus on creating believable movement using Autodesk Maya.", bio2: "I enjoy the process of bringing characters to life through physics-based animation.", software: "Software", skills: "Specialisations", softwareList: ["Autodesk Maya", "Blender", "After Effects"], skillsList: ["Character Animation", "Motion Editing", "Motion Design"], statsExp: "Learning Mindset", statsProj: "Autodesk Maya", statsStyle: "Character Animation", labelExp: "Approach", labelProj: "Main Tool", labelStyle: "Focus", openToWork: "Open to Work", openToWorkDesc: "Currently looking for Junior 3D Animation roles or freelance opportunities to bring characters to life." },
  ...
  ru: {
    ...
    hero: { greeting: "Привет, я", name: "Умидбек Каримов", role: "Junior 3D Animator | Motion Designer", bio: "Как Junior 3D-аниматор и Motion Designer, я специализируюсь на создании плавных, динамичных 3D-анимаций и видеоконтента. Моё внимание сосредоточено на освоении фундаментальных основ движения — веса, тайминга и сторителлинга — в Autodesk Maya и After Effects для создания высококачественного визуального опыта. Открыт к работе на полную занятость и фрилансу в игровых студиях, анимационных производствах и видеоагентствах.", cta1: "Смотреть Showreel", cta2: "Написать", badge: "Открыт к работе", scroll: "Вниз" },
    work: { label: "Моё портфолио", heading: "Оживляя\nцифровых персонажей", showreelTitle: "Production Showreel 2026", showreelMeta: "2 мин 30 сек  ·  HD 1080p", projects: [{ title: "Post - Production & Commercial Motion", category: "Motion Capture · Post-Production" }, { title: "Soon..", category: "3D · CGI" }] },
    about: { label: "Обо мне", heading: "Увлечён\n3D Анимацией Персонажей", bio1: "Я Junior 3D-аниматор, посвятивший себя изучению движения персонажей. Я фокусируюсь на создании правдоподобных движений в Autodesk Maya.", bio2: "Мне нравится процесс оживления персонажей через физически корректную анимацию.", software: "Инструменты", skills: "Специализации", softwareList: ["Autodesk Maya", "Blender", "After Effects"], skillsList: ["Character Animation", "Motion Editing", "Motion Design"], statsExp: "Learning Mindset", statsProj: "Autodesk Maya", statsStyle: "Character Animation", labelExp: "Подход", labelProj: "Инструмент", labelStyle: "Фокус", openToWork: "Открыт к работе", openToWorkDesc: "Ищу позиции Junior 3D Animator или фриланс-проекты для оживления персонажей." },
  ...
  uz: {
    ...
    hero: { greeting: "Salom, men", name: "Umidbek Karimov", role: "Junior 3D Animator | Motion Designer", bio: "Junior 3D Animator va Motion Designer sifatida men ravon, ishlash-yo'nalishli 3D animatsiyalar va dinamik video kontent yaratishga ixtisoslashganman. Mening asosiy e'tiborim harakatning fundamental prinsiplari — og'irlik, tayming va hikoyachilik — ni Autodesk Maya va After Effects da o'zlashtirish orqali yuqori sifatli vizual tajriba yaratishga qaratilgan. O'yin studiyalari, animatsiya ishlab chiqarish va video agentliklarda to'liq kunlik va frilanс imkoniyatlariga ochiqman.", cta1: "Showreelni ko'rish", cta2: "Bog'lanish", badge: "Ishga tayyor", scroll: "Pastga" },
    work: { label: "Mening ishlarim", heading: "Raqamli qahramonlarga\nhayot bag'ishlash", showreelTitle: "Production Showreel 2026", showreelMeta: "2 daqiqa 30 soniya  ·  HD 1080p", projects: [{ title: "Post - Production & Commercial Motion", category: "Motion Capture · Post-Production" }, { title: "Soon..", category: "3D · CGI" }] },
    about: { label: "Men haqimda", heading: "3D Belgi Animatsiyasiga\nIshtiyoqmandman", bio1: "Men belgi harakatini o'rganishga bag'ishlangan Junior 3D animatorman. Autodesk Maya yordamida ishonchli harakatlar yaratishga e'tibor qarataman.", bio2: "Fizikaga asoslangan animatsiya orqali qahramonlarga hayot bag'ishlash jarayonidan zavqlanaman.", software: "Dasturlar", skills: "Ixtisosliklar", softwareList: ["Autodesk Maya", "Blender", "After Effects"], skillsList: ["Character Animation", "Motion Editing", "Motion Design"], statsExp: "Learning Mindset", statsProj: "Autodesk Maya", statsStyle: "Character Animation", labelExp: "Yondashuv", labelProj: "Asosiy vosita", labelStyle: "Yo'nalish", openToWork: "Ishga tayyor", openToWorkDesc: "Junior 3D Animation yoki freelance imkoniyatlar uchun ochiqman — qahramonlarga hayot bag'ishlash." },
